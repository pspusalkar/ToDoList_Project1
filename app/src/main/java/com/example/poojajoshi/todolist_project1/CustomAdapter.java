...
public class CustomAdapter extends BaseAdapter{
    ...
    public CustomAdapter(MainActivity mainActivity, String[] titleList, String[] timestampList, String[] descriptionList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.img_status.setImageResource(R.drawable.incomplete);
